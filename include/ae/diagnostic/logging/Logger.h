...
#else
#define AE_LOG_T() NOOP
#define AE_LOG_T(fmtStr, ...) NOOP
#define AE_LOG_D(fmtStr, ...) NOOP
#endif
...
#else
#define AE_LOG_H_T(useHeader, fmtStr, ...) NOOP
#define AE_LOG_H_D(useHeader, fmtStr, ...) NOOP
#endif
