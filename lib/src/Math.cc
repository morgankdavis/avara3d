...
f32mat4 operator-(const f32mat4& m) {
    return f32mat4 {f32vec4 {-m.c0.x, -m.c0.y, -m.c0.z, -m.c0.w}, f32vec4 {-m.c1.x, -m.c1.y, -m.c1.z, -m.c1.w},
                    f32vec4 {-m.c2.x, -m.c2.y, -m.c2.z, -m.c2.w}, f32vec4 {-m.c3.x, -m.c3.y, -m.c3.z, -m.c3.w}};
}
...
f32 ease_in_out_elastic(f32 t) {
    ...
    return (math::pow(f32(2), -f32(20) * t + f32(10)) * math::sin((f32(20) * t - f32(11.125)) * c5)) / f32(2)
           + f32(1);
}
...
f32vec4 lerp_linear_rgba(const f32vec4& a, const f32vec4& b, f32 t) {
    return f32vec4 {a.r + (b.r - a.r) * t, a.g + (b.g - a.g) * t, a.b + (b.b - a.b) * t, a.a + (b.a - a.a) * t};
}
