...
static shared_ptr<Node> PhysicsChainElement(int radius, int height);
...
void SpawnInvisiblePrimitives(Scene& scene) {
	...
	{ // box
		auto node = Node::NamedNode("invisible Box physics shape node");
	...
	{ // capsule
		auto node = Node::NamedNode("invisible Capsule physics shape node");
	...
	{ // cone
		auto node = Node::NamedNode("invisible Cone physics shape node");
	...
	{ // cylinder
		auto node = Node::NamedNode("invisible Cylinder physics shape node");
	...
	{ // plane
		auto node = Node::NamedNode("invisible Plane physics shape node");
	...
	{ // sphere
		auto node = Node::NamedNode("invisible Sphere physics shape node");
...
shared_ptr<Node> PhysicsChainElement(int radius, int height) {
